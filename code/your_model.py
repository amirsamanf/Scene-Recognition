...
class YourModel(ModelDesc):
    ...
    def _build_graph(self, inputs):
        ...
        logits = Conv2D('conv0', image, 10, (9,9), padding='same', stride=(1,1), nl=tf.nn.relu)
        #
        ...
        logits = MaxPooling('pool0', logits, (7,7), stride=None, padding='same')
        #
        logits = tf.layers.dense(inputs=logits,units=hp.img_size,activation=tf.nn.relu)
